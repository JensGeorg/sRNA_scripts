...
#R --slave -f  ~/media/jens@margarita/sRNA_scripts/network_modifications5.r --args script_path=~/media/jens@margarita/Syntney/packages/GENBANK_GROPER_SQLITE/genbank_groper_sqliteDB.py db_path=~/synt_rRNA_fayyaz.db filename=/home/jens/media/jens@margarita/Staph_enrichment/01_GLASSgo_Results/01_GLASSgo_Results/01_GLASSgo_Results/01_GLASSgo_Results/GLASSgo_output_HG001_02998.fa   only_sig_nodes=FALSE thres_anno=0.001 thres_edge=0.001
